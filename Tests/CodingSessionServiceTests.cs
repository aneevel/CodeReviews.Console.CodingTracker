...
public class CodingSessionServiceTests
{
    ...
    public void GetCodingSessions_ShouldReturnAListOfCodingSessions_WhenListOfCodingSessionsExist()
    {
        ...
        _mockCodingSessionRepository
            .Setup(repository => repository.GetCodingSessions())
            .Returns(expected);
    ...
    public void InsertCodingSession_ShouldReturnA0_WhenSuccessful()
    {
        ...
        _mockCodingSessionRepository
            .Setup(repository => repository.InsertCodingSession(It.IsAny<CodingSession>()))
            .Returns(expected);
    ...
    public void UpdateCodingSession_ShouldReturnA0_WhenSuccessful()
    {
        ...
        _mockCodingSessionRepository
            .Setup(repository =>
                repository.UpdateCodingSession(
                    It.IsAny<int>(),
                    It.IsAny<DateTime>(),
                    It.IsAny<DateTime>(),
                    It.IsAny<TimeSpan>()
        ...
        var result = _codingSessionService.UpdateCodingSession(
            1,
            DateTime.Now,
            DateTime.Now,
            TimeSpan.MaxValue
    ...
    public void DeleteCodingSession_ShouldReturnA0_WhenSuccessful()
    {
        const int expected = 0;
        _mockCodingSessionRepository
            .Setup(repository => repository.DeleteCodingSession(It.IsAny<int>()))
            .Returns(expected);
